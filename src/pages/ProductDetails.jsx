  ...
  const products = [
    {
      ...
      oldPrice: 300000,
      images: [
        "/assets/images/new-img/lastic.jpg",
        "/assets/images/new-img/lastic3.jpg",
        "/assets/images/new-img/lastik2.jpg",
      ],
    },
  ];
      ...
      <div className="w-full lg:w-1/2">
        <div className="flex flex-col md:flex-row">
          ...
          <div className="w-full md:w-1/2 p-4">
            ...
            <p className="text-gray-500 mb-4">دسته بندی: {product.category}</p>
